package kim.biryeong.perfume.service;
...
import kim.biryeong.perfume.dto.*;
import kim.biryeong.perfume.repository.*;
    ...
    public PerfumeDetailResponse getPerfumeDetail(Long id) {
        ...
        var notesByType = perfumeNoteRepository.findByPerfumeId(perfume.getId()).stream()
                .collect(Collectors.groupingBy(
                        n -> n.getNoteType(),
                        Collectors.mapping(n -> n.getNoteName(), Collectors.toList())
                ));
